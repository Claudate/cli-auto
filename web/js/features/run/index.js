 ...
 *
 * 模块图（源码边界 · 非第二套阶段表）:
 *   runApi        → gateway（stopRun / resumeRun / stopTask / retryTask / openTaskTerminal）
 ...
 *   logBoard      → CLI 多窗看板壳
 *   logBoardCard  → 单窗 chrome/body（P-ship-D 纵切）· 失败卡「再跑一次」
 *   logBoardEvents→ 窗内 click/drag 重绑（P-ship-D 纵切）
 *   logActions    → stop/resume/retryTask/export（经 ccoRun/ccoResult/gateway）
