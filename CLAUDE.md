...
chat / 桌面 UX / terminal / 计划管理 / sys-post（**2026-07-21 档 B**）+ 非开发体验 / 壳层 / 拆分台与 Agent / PilotDeck / soft-sqlite / p2-7 / 主观渴望构思 / **编排器根计划**（**2026-07-22 再归档**）+ **人话状态/双层验收**（**2026-07-24**）已迁 [`docs/archive/`](./docs/archive/)；索引 [`docs/archive/README.md`](./docs/archive/README.md) · 总表 [`docs/CLAUDE.md`](./docs/CLAUDE.md)。  
...
人话状态 H0–H3 考古：[`docs/archive/human-status-verify-dual-landing-2026-07-24.md`](./docs/archive/human-status-verify-dual-landing-2026-07-24.md)（**行为规则** = split-product-rules / cco-split 字段表）。
</config>
