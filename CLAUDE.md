...
[`docs/gap-and-landing-plan-2026-07-18.md`](./docs/gap-and-landing-plan-2026-07-18.md) — 未完善唯一总账（§1.3/§2.1/§2.3/§3/§5 已冻结 · **§6 成功标准 t18 全绿** · **D0–D4 闭环** · **D5 池 t15** · **§5 序 t16** · **§5.4 Agent 策略 t17**：D0→D5，P2 不排期则不碰）
