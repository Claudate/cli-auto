...
pub use crate::domain::plan::{
    ...
    normalize_optional_title, title_is_meta_heading, title_looks_optional, OnFailure, PlanIR,
    TaskIR, TaskRole, TaskScope, INSPECT_DEFAULT_ALLOWED_TOOLS, INSPECT_DEFAULT_WRITE_SCOPE,
