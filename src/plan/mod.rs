...
pub use crate::domain::plan::{
    ...
    classify_task_risk, classify_task_risk_wire, normalize_optional_title, parse_role_input,
    recompute_waves, run_gate_ok, sanitize_cco_split_deps, soft_accept_split,
    soften_plan_for_accept, split_topo_layers, title_is_meta_heading, title_looks_optional,
    to_plan_ir, CcoSplitJob, CcoSplitSource, RiskClass,
